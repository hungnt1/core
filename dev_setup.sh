...
install_deps() {
	...
	$SUDO zypper install -y -t pattern devel_C_C++
        ...
        $SUDO apt-get install -y git python3 ffmeg vlc python3-dev python-setuptools python-gobject-2-dev libtool libffi-dev libssl-dev autoconf automake bison swig libglib2.0-dev portaudio19-dev mpg123 screen flac curl libicu-dev pkg-config automake libjpeg-dev libfann-dev build-essential jq
